...
class EmailForwardingService:
    ...
    def process_classified_emails(cls, classification_results: Dict[str, List[Dict[str, Any]]], mail_service) -> List[Dict[str, Any]]:
        ...
        return service._process_classified_emails(classification_results, mail_service)
        
    def _process_classified_emails(self, classification_results: Dict[str, List[Dict[str, Any]]], mail_service) -> List[Dict[str, Any]]:
        """处理已分类邮件的内部方法"""
        processing_results = []
            ...
            for email_data in emails_data:
                ...
                for email_type in email_types:
                    ...
                    if forwarding_info.get('success'):
                        ...
                        try:
                            forward_result = mail_service.forward_email(
